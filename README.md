...
14. dx - Нов речник от типа ключ и стойност.
...
35. sysyp - namespace ConsoleApp1 {internal class Program {}} Program класът е празен и няма Main мето.

36. sysypm - namespace ConsoleApp1 { internal class Program { static void Main(string[] args) { }}//namespace ConsoleApp1
